  ...
  USERS: [
    {
      ...
      id: 'ktsL2CE62P7SGIYyEAijdTnMT6s4_T7eQ4bQ4neg4q4',
      // 使用微信测试号：你想对他发送的模板消息的模板ID
      useTemplateId: '1lxoQk7LzH5GlpBDnIBDFStD30ujcbPldNDFwLX88vQ',
      festivals: [
        {
          type: '*生日', name: '我家宝宝', year: '2004', date: '08-05', isShowAge: true,
        },
